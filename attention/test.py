...
def test(attention_model,train_loader,test_loader,criterion,opt,epochs = 5,GPU=True):
    attention_model.load_state_dict(torch.load(path_name+'/model_best.pth'))
    # "model_best.pth" is the trained model with the best hyper-parameter settings
